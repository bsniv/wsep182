...
var createTables = function() {
    ...
    db.serialize(function() {
        ...
        db.run("INSERT OR IGNORE INTO Users (userName, Password, Role) VALUES ( 'admin', '123456',1,1)");

        db.run("CREATE TABLE IF NOT EXISTS Store "+
            "( storeId Integer PRIMARY KEY AUTOINCREMENT, storeName varchar(15) unique,isActive Integer 1)");

        db.run("CREATE TABLE IF NOT EXISTS Product "+
            "( productId Integer PRIMARY KEY AUTOINCREMENT, ProductName varchar(10) unique, basePrice Integer)");

        db.run("CREATE TABLE IF NOT EXISTS ProductInStore "+ //TODO: check if productInStoreId is primery key
          ...
          //"CONSTRAINT PKProductInStore PRIMARY KEY (productId, storeId))"
       ")" );
        ...
        db.run("CREATE TABLE IF NOT EXISTS Session "+
            ...
            " CONSTRAINT PKsession PRIMARY KEY (userName, cookies) )");
        ...
        db.run("CREATE TABLE IF NOT EXISTS StoreOwners "+
            "(storeId Integer, userName Integer, " +
            "FOREIGN KEY(storeId) REFERENCES Store(storeId) ON UPDATE CASCADE," +
        ...
        db.run("CREATE TABLE IF NOT EXISTS BuyHistory "+
            "( buyId PRIMARY KEY AUTOINCREMENT, productId Integer ,storeId Integer,date varchar(30) NOT NULL," +
        ...
        db.run("CREATE TABLE IF NOT EXISTS StroreManager "+
            "(storeId Integer, userName Integer,addProduct Integer, removeProduct Integer," +
